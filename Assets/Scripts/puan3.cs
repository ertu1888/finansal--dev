...
public class puan3 : MonoBehaviour
{
    public float hiz;
    public bool aktif;
    ...
    {
        objeler.transform.localPosition = new Vector2(20, Random.Range(3.8f, -4.5f));
    }

    public void trueYap()
    {
        objeler.transform.localPosition = new Vector2(-7, 0); // ufoya deydikten sonra ekran dışına taşı 
